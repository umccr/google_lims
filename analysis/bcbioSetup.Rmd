...
umccrise . -j 16 --cluster-auto` # by default outputs to 'umccrise'
## or use `umccrise /path/to/bcbio/final -j 16 --cluster-auto -o umccrise_alternative_name`
```
