---
title: "UMCCR bcbio single patient config for samples with UMIs"
...
bcbio <- bcbio %>%
  mutate(fastq = str_replace(fastq,
                             's3://umccr-fastq-data-prod/200702_A00130_0137_AH5KMHDSXY/',                       '/data/cephfs/punim0010/projects/Hofmann_Demultiplexing/200702_A00130_0137_AH5KMHDSXY/Fastq_Exome_200702_A00130_0137_AH5KMHDSXY/'))
```
