...
do
  ...
  if [ -n "$(ls -A $RUNDIR/final)" ]; then
	...
	BAM=$RUNDIR/final/$SAMPLE/$SAMPLE-ready.bam
        ...
        draw_fusions.R --fusions=$FUSION --alignments=$BAM  --output=$PDF --annotation=/g/data3/gx8/local/development/bcbio/genomes/Hsapiens/GRCh37/rnaseq/ref-transcripts.gtf --cytobands=/g/data/gx8/extras/arriba/cytobands_hg19_hs37d5_GRCh37_2018-02-23.tsv --proteinDomains=/g/data/gx8/extras/arriba/protein_domains_hg19_hs37d5_GRCh37_2018-03-06.gff3
        echo "--"
      else
